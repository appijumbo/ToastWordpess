...
?>
    ...
    <section class="success" id="about">
        <div class="container">
           ...
           <?php 
            ...
            <!-- wp_reset_query() restores the $wp_query and global post data to the original main query. This function should be called after query_posts(), if you must use that function. As noted in the examples below, it's heavily encouraged to use the pre_get_posts filter to alter query parameters before the query is made. tinyurl.com/qgawlyz  -->
        </div>
    </section>
   ...
   <!-- The Portfolio Modals need to be in a loop -->
    <?php 
                            ...
                            <div class="col-lg-8 col-lg-offset-2">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline item-details">
                                        ...
                                        <li>Date:
                                            <strong><a href="http://startbootstrap.com"><?php the_date('M Y') ?></a>
                                            </strong>
                                        </li>
                                        <li>Service:
